...
Diff3Base.create = async.void(function(self, pivot)
  ...
  self.a.file.get_data = get_data_him
  self.c.file.get_data = get_data_him

  -- Lifted from Window.load_file with the is_valid check removed because it was causing problems
